...
const Card = React.forwardRef(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "rounded-[24px] border border-border/40 bg-background/60 text-foreground shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-lg hover:border-border/80",
            className
        )}
        {...props}
    />
